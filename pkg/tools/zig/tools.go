	...
	tools.BinaryTool{
		...
		Sources: tools.Sources{
			tools.PlatformLinuxAMD64: {
				URL:  "https://ziglang.org/download/0.15.2/zig-linux-x86_64-0.15.2.tar.xz",
				Hash: "sha256:d45312e61ebcc48032b77bc4cf7fd6915c11fa16e4aad116b66c9468211230ea",
				Links: map[string]string{
					"bin/zig": "zig-linux-x86_64-0.15.2/zig",
				},
			},
			tools.PlatformDarwinAMD64: {
				URL:  "https://ziglang.org/download/0.15.2/zig-macos-x86_64-0.15.2.tar.xz",
				Hash: "sha256:8b06ed1091b2269b700b3b07f8e3be3b833000841bae5aa6a09b1a8b4773effd",
				Links: map[string]string{
					"bin/zig": "zig-macos-x86_64-0.15.2/zig",
				},
			},
			tools.PlatformDarwinARM64: {
				URL:  "https://ziglang.org/download/0.15.2/zig-macos-aarch64-0.15.2.tar.xz",
				Hash: "sha256:46fae219656545dfaf4dce12fb4e8685cec5b51d721beee9389ab4194d43394c",
				Links: map[string]string{
					"bin/zig": "zig-macos-aarch64-0.15.2/zig",
				},
			},
		},
	},
